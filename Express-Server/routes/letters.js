...
mongoose.connect("mongodb://localhost:27017/QuranDb");
...
var Letter_model = mongoose.model("Letter", letterSchema);
      ...
      if (rec != 0) {
        ...
        Letter_model.findOneAndUpdate(
          ...
          function(err) {
            ...
            console.log("Letters accuracy updated successfully");
            //res.json("accuracy updated successfully ");
            res.json({
