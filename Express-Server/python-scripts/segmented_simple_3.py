...
def detect_leading_silence(sound, silence_threshold=-29, chunk_size=10):
...
#        Prediction 
        ...
        model.load_weights("F:\\fyp-server\\python-scripts\\letters_models\\segmented_simple_3.h5")
